...
$services = array(
    ...
    array(
        ...
        'url' => "decapado-de-superficies-metalicas"
    ),
    ...
    array(
        ...
        'url' => "decapado-y-limpieza-de-piscinas"
    ),
    ...
    array(
        ...
        'url' => "decapado-limpieza-mantenimiento-de-madera"
    ),
...
$jobs = array(
    ...
    array(
        'img' => 'tr-1.jpg',
        'overlay_text' => 'Trabajo limpieza fachada antigua'
    ),

    array(
        'img' => 'tr-2.jpg',
        'overlay_text' => 'Restauración monumentos'
    ),

    array(
        'img' => 'tr-3.jpg',
        'overlay_text' => 'Restauración de valla metálica'
    ),

    array(
        'img' => 'tr-4.jpg',
        'overlay_text' => 'Limpieza de techo con hielo seco tras incendio'
    ),

    array(
        'img' => 'tr-5.jpg',
        'overlay_text' => 'Limpieza de óxido en cubierta de barco'
    ),

    array(
        'img' => 'tr-6.jpg',
        'overlay_text' => 'Limpieza y restauración de suelo en nave industrial'
    ),
);
